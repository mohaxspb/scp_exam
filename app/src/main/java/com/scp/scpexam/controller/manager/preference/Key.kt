...
object Key {
    ...
    const val TRUE_ACCESS_TOKEN = "TRUE_ACCESS_TOKEN"
    const val REFRESH_TOKEN = "REFRESH_TOKEN"
    const val APPODEAL_DESCRIPTION_SHOWN = "APPODEAL_DESCRIPTION_SHOWN"
    const val USER_PASSWORD = "USER_PASSWORD"
    const val NEVER_SHOW_AUTH = "NEVER_SHOW_AUTH"
    const val PERSONAL_DATA_ACCEPTED = "PERSONAL_DATA_ACCEPTED"
    const val NEVER_SHOW_ADMIN_APP_ADS= "NEVER_SHOW_ADMIN_APP_ADS"
}